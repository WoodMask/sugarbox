...
<mapper namespace="${targetPackage}.${domainObjectClassName}Mapper" >
    ...
    <insert id="insertSelective" parameterType="${modulePackage}.model.${domainObjectClassName}" useGeneratedKeys="true"
            keyProperty="${primaryKeyColumn.columnName}" keyColumn="${primaryKeyColumn.actualColumnName}" >
